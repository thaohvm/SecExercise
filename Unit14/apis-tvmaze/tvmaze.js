      ...
      `<div class="col-md-6 col-lg-3 Show" data-show-id="${show.id}">
         ...
         <img src="${show.image}">
           <div class="card-body">
             ...
             <button class="btn btn-primary" id="episodes-btn">Episodes</button>
           </div>
         </div>
       </div>
      `);
...
//handle episodes click event

$("#shows-list").on("click", "#episodes-btn", async function handleEpisodeClick(evt) {
